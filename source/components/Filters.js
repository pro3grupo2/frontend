    ...
    return (
        <>
            <div className="row mb-4">
                ...
                <div className="col-1 filterButtons d-flex align-items-center me-3">
                    <div className="border border-black border-2 rounded w-100 h-75">
                ...
                <div className="col-1 filterButtons d-flex align-items-center me-3">
                    <div className="dropdown w-100 h-75">
                        <input id="yearButton" type="number" min={1900} max={new Date().getFullYear()} step={1}
                               className="form-control border-black border-2 h-100" value={anio}
                               onChange={(e) => handleYear(e.target.value)}/>
                    </div>
                </div>
                <div id="changeBorder"
                     className="col py-2 border border-black border-2 rounded d-flex align-items-center input-group input-group-lg">
