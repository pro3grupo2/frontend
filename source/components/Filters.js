    ...
    return (
        <>
            <div className="d-flex flex-row flex-wrap justify-content-center gap-3">
                ...
                <select
                    className={`${filters_show && 'd-none'} clickable ms-regular-subbody form-select border-black border-2 rounded`}
                    style={{height: 40, width: 158}}
                    onChange={(e) => {
                ...
                <input
                    ...
                    step={1}
                    className={`${filters_show && 'd-none'} ms-regular-subbody border-black border-2 rounded text-center`}
                    style={{height: 40, width: 158}}
                ...
                <div
                    className={`${filters_input_focus ? 'border-primary' : 'border-black'} position-relative flex-grow-1 d-flex flex-row flex-nowrap justify-content-start align-items-center border border-2 rounded p-3`}
                    style={{height: 40}}>
