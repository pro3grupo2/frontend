        ...
        <>
            <div className="row mb-5">
                ...
                <div id="changeBorder" className="col py-2 border border-black border-2 rounded d-flex align-items-center input-group input-group-lg">
                    ...
                    <input id="searchbar" onBlur={() => changeFocus(false)} onFocus={() => changeFocus(true)} onChange={(e) => onSearchChange(e)} onKeyDown={(e) => handleSearch(e)} className="form-control border-0 py-2 focus-ring" style={{"--bs-focus-ring-color": "rgba(var(--bs-success-rgb), 0)"}} type="search" placeholder="Buscar un proyecto o escribir el correo de algún miembro"></input>
                </div>
            </div>
