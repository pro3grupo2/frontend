                ...
                <div className="col-md-6">
                    ...
                    <form onSubmit={handleSubmit} className='w-100'>
                        ...
                        <div className='d-flex justify-content-between'>
                            ...
                            <button type='submit' onClick={setNextPaso} className='btn btn-primary btn-color-primary btn-outline-primary border-5 py-1 px-5 fs-5 fw-bold'>CREAR CUENTA</button>
                        </div>
                    </form>
                </div>
            </div>
