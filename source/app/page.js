...
export default function HomePage() {
    ...
    return (
        <div className="container-fluid bg-image-main text-center d-flex flex-column justify-content-center align-items-center mx-0">
            <h1 className="display-1 custom-bold mt-4">Trabajos de alumnos/nis</h1>
            <p className="custom-bold fs-2 mb-4">¡Descubre aquí el talento U-tad!</p>
            <p className="ms-light fs-5 mt-5">Bienvenido al repositorio de proyectos oficial de la U-tad.</p>
