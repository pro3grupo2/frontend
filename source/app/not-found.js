            ...
            <div className="d-flex flex-column justify-content-between gap-5 w-50 h-50">
                <div className="d-flex flex-column gap-3">
                    ...
                    <div className="d-flex flex-column flex-sm-row gap-3">
                        <Link href="/home" className="notfound-boton btn btn-primary w-25 background-color-principal color-secundario-blanco p-2" style={{ minWidth: "fit-content" }}>Proyectos</Link>
                        <Link href="/soporte" className="notfound-boton btn btn-outline-primary w-25 background-color-secundario-blanco p-2" style={{ minWidth: "fit-content" }}>Centro de ayuda</Link>
                    </div>
                </div>
